...
def main(input, output, replay_episode, robot_ip, gripper_ip, 
    ...
    replay_buffer = ReplayBuffer.create_from_path(input, mode='r')
    ...
    for robot_idx in range(1):
        ...
        # tcp_pose = mat_to_pose(pose)
        pose_data[f'robot{robot_idx}_tcp_pose'] = pose
        ...
        with Spacemouse(shm_manager=shm_manager) as sm, \
            ...
            while True:
                ...
                while True:
                    ...
                    drot_xyz = sm_state[3:] * (env.max_pos_speed/ frequency)
                ...
                try:
                    ...
                    print(f"n_data_samples is {n_data_samples}")
                    ...
                    actions = np.zeros((len(exec_timestamps), 7))
                    for robot_idx in range(1):
                    ...
                    for iter_idx, _ in enumerate(exec_timestamps):
                        ...
                        #     img = episode_data[f'camera_{camera_idx}'][data_idx]
                        #     vis_img = obs[f'camera_{camera_idx}'][-1]
