...
from umi.sim_world.uvc_camera import UvcCamera
...
@click.option('-ch', '--camera_hostname', default='0.0.0.0')
@click.option('-cp', '--camera_port', default='65433')
@click.option('-f', '--frequency', type=float, default=30)
@click.option('-s', '--steps_per_inference', type=int, default=16)
def main(input, robot_hostname, gripper_hostname, camera_hostname, camera_port, gripper_port, frequency, steps_per_inference):
    cv2.setNumThreads(1)
