...
from umi.real_world.state_recorder import VideoRecorder
...
class RealEnv:
    def __init__(self, 
        ...
        video_recorders.append(VideoRecorder.create_h264(
            robot=robots[0],
            gripper= grippers[0],
            fps=recording_fps, 
            codec='h264',
        ...
        camera = MultiUvcCamera(
            ...
            video_recorder=video_recorders,
            verbose=False
        )
    ...
    def get_obs(self) -> dict:
        ...
        #print(f"last_robot_data: {last_robot_data} \n last_gripper_data: {last_gripper_data}")
